...
class DownloadCenterRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
             'name' => 'bail|required|regex:/^[a-z 0-9 A-Z\s-_.]+$/|max:50|min:2',
             ...
             'file.*'=> 'bail|required|mimes:txt,sql,doc,pdf,docx,zip,pptx,pps,xls,jpeg,png,jpg,gif,svg'.$excepId,
        ];
    }
    ...
    {
        return [
            'file.*.mimes'=>'The file must be a file of type: txt, sql, doc, pdf, docx, zip, pptx, pps, xls, jpeg, png, jpg, gif, svg'
        ];
    }
}
